      ...
      <section
        ...
        <div className="flex flex-col items-center justify-between w-full h-full max-w-6xl px-4 mx-auto md:px-0">
          <div className="flex items-center justify-center w-full">
            <p className="relative mb-12 text-2xl font-semibold transition-all duration-100 ease-in-out before:absolute before:rounded-lg before:content before:w-20 before:h-1 before:-bottom-2 before:left-11 before:bg-gradient-to-br from-hoverColor to-logoColor text-mainColor">
          ...
          <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            <div className="flex items-center justify-center w-full py-2 cursor-pointer group">
              ...
              <p className="px-2 text-base md:text-lg text-mainColor group-hover:text-logoColor">
                +38 077 777 77 77{' '}
              </p>
            </div>
            <div className="flex items-center justify-center w-full py-2 cursor-pointer group">
            ...
            <div className="flex items-center justify-center w-full gap-4 py-2">
              <BsLinkedin className="text-lg transition-all duration-100 ease-in-out cursor-pointer text-mainColor hover:text-logoColor" />
              <BsFacebook className="text-lg transition-all duration-100 ease-in-out cursor-pointer text-mainColor hover:text-logoColor" />
              <BsInstagram className="text-lg transition-all duration-100 ease-in-out cursor-pointer text-mainColor hover:text-logoColor" />
            </div>
          </div>
        </div>
      </section>
