  ...
  return (
    <section
      ...
      <div className="flex flex-col items-center justify-between w-full h-full px-4 mx-auto md:px-0 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-[5px] w-full min-h-screen h-auto mt-17 md:mt-[30px] p-6 px-10 md:px-16 py-4">
          <div className="flex flex-col items-start justify-start flex-1 gap-6 py-2 mt-16 xl:justify-center md:mt-18 xl:mt-0">
            <div className="flex items-center justify-center gap-[5px] px-4 py-1 rounded-full bg-[#fdfdfd91]">
          ...
          <div className="relative flex items-center flex-1 lg:justify-center">
            <div
              className="flex flex-col items-center justify-center w-full p-2 md:p-6 md:w-[510px] rounded-2xl backdrop-filter backdrop-blur-md"
              style={{
