...
const MainContainer = () => {
  ...
  const [defaultCategory] = useState('candle');
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-auto">
      <HomeContainer />
      <section className="relative w-full p-6 px-10 py-6 mt-16 md:px-16 lg:px-20 before:w-full before:left-0 before:top-0 before:bg-mainTextGrey before:content before:absolute after:w-full after:left-0 after:bottom-0 after:bg-mainTextGrey after:content after:absolute">
